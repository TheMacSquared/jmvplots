...
hexbinOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "hexbinOptions",
...
hexbinResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "hexbinResults",
    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Image$new(
                ...
                width=550,
                height=500,
                renderFun=".hexbinPlot"))}))

hexbinBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "hexbinBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = hexbinResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#' \tabular{llllll}{
#'   \code{results$plot} \tab \tab \tab \tab \tab an image containing the hexbin plot \cr
#' }
#'
#' @export
hexbin <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("hexbin requires jmvcore to be installed (restart may be required)")
